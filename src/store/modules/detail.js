...
const fetchDetailCredit = (movieId, filter) => {
    return (dispatch) => {
        ...
        axios.get(`https://api.themoviedb.org/3/movie/${movieId}/credits?api_key=${API_KEY}&language=ko-KR`)
            .then(response => {
...
const fetchDetailVideo = (movieId, filter) => {
    return (dispatch) => {
        dispatch(fetchDetailRequest(filter))
        axios.get(`https://api.themoviedb.org/3/movie/${movieId}/videos?api_key=${API_KEY}&language=ko-KR`)
            .then(response => {
                dispatch(fetchDetailSuccess(response.data, filter))
            })
            .catch(error => {
...
const fetchDetailRecommendation = (movieId, filter) => {
    return (dispatch) => {
        dispatch(fetchDetailRequest(filter))
        axios.get(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=${API_KEY}&language=ko-KR&page=1`)
            .then(response => {
                dispatch(fetchDetailSuccess(response.data, filter))
            })
            .catch(error => {
